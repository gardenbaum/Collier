...
1. **t-m0-fixture** (R2) — fixture script + a Rust integration test that loads it via the bd-runner. *(needs bd installed)*
...
*(Operator prerequisite, not a card: install `bd` in the container — pending your choice of source.)*
